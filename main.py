...
def edit():
    ...
    data=cursor.fetchall()
    for i in data:
        data1=OrderedDict([('.',[i[0],'hidden']), ('College_Name',[i[1],'text']), ('Location',[i[2],'text']), ('HOD_Name',[i[3],'text']), ('Contact_Details',[i[4],'tel']), ('Seminar_Date',[i[5],'Date']), ('Topic',[i[6],'text']), ('Expectation',[i[7],'textarea'])])
...
def upedit():
    ...
    data=cursor.fetchall()
    for i in data:
        data1=OrderedDict([('.',[i[0],'hidden']), ('College_Name',[i[1],'text']), ('Location',[i[2],'text']), ('HOD_Name',[i[3],'text']), ('Contact_Details',[i[4],'tel']), ('Seminar_Date',[i[5],'Date']), ('Topic',[i[6],'text']), ('Approach_Date',[i[7],'Date']), ('Follow_Up1',[i[8],'textarea']),('Follow_Up2',[i[9],'textarea']),('Follow_Up3',[i[10],'textarea'])])
...
def paidedit():
    ...
    data=cursor.fetchall()
    for i in data:
        data1=OrderedDict([('.',[i[0],'hidden']), ('College_Name',[i[1],'text']), ('Location',[i[2],'text']), ('HOD_Name',[i[3],'text']), ('Contact_Details',[i[4],'tel']), ('Seminar_Date',[i[5],'Date']), ('Topic',[i[6],'text']), ('Remark',[i[7],'textarea'])])
...
def update():
    ...
    data=cursor.fetchall()
    for i in data:
        data1=OrderedDict([('.',[i[0],'hidden']), ('College_Name',[i[1],'text']), ('Location',[i[2],'text']), ('HOD_Name',[i[3],'text']), ('Contact_Details',[i[4],'tel']), ('Seminar_Date',[i[5],'Date']), ('Topic',[i[6],'text']),('Approach_Date',[i[7],'Date']), ('Follow_Up1',['','textarea']),('Follow_Up2',['','textarea']),('Follow_Up3',['','textarea'])])
    return render_template("updateform.html",data=data1,frmtype="Update")
...
def updateup():
    ...
    data=cursor.fetchall()
    for i in data:
        data1=OrderedDict([('.',[i[0],'hidden']), ('College_Name',[i[1],'text']), ('Location',[i[2],'text']), ('HOD_Name',[i[3],'text']), ('Contact_Details',[i[4],'tel']), ('Seminar_Date',[i[5],'Date']), ('Topic',[i[6],'text']),('Remark',['','textarea'])])
    return render_template("paidform.html",data=data1,frmtype="Update2")
